...
const variantClass = {
  ...
  secondary: 'border-line bg-white text-ink hover:bg-panel focus:ring-slate-200',
  ghost:
    'border-transparent bg-transparent text-muted hover:bg-panel hover:text-ink focus:ring-slate-200',
};
